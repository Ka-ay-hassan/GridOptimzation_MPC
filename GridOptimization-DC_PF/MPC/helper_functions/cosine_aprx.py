...
for x0 in tangent_points:
    ...
    plt.plot(x_vals, tangent_line, color='red', linestyle='--', alpha=1, linewidth=2.5)  # thicker dashed lines

# Final touches
plt.axhline(0, color='gray', linewidth=1)
plt.axvline(0, color='gray', linewidth=1)
plt.title("Cosine Function with Tangent Approximations", fontsize=24)
plt.xlabel("θ (radians)", fontsize=24)
plt.ylabel("cos(θ)", fontsize=24)
plt.legend(fontsize=22)
plt.ylim(0.9, 1.01)  # Set y-axis limits
